...
The interface already includes a 33Ω protective resistor on the /HALT line internally. No modification to the ZX81 is required. There is no jumper to disable this feature on the current hardware version.
